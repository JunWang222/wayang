...
/**
 * Channel conversions for Presto.
 */
public class PrestoChannelConversions {

    public static final ChannelConversion SQL_TO_STREAM_CONVERSION = new DefaultChannelConversion(
            PrestoPlatform.getInstance().getGenericSqlQueryChannelDescriptor(),
            StreamChannel.DESCRIPTOR,
            () -> new GenericSqlToStreamOperator(PrestoPlatform.getInstance())
    );
